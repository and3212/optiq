...
const double PICTURE_SCALE = 1; //2.5
const double METRIC = 25.4;
const double TRANSLATE_X = 0; //-12
const double TRANSLATE_Y = 0; //-10
...
double iCoord = 0;
double jCoord = 0;
double speed = 15; //in/second * (SCALE units/1 in)
double totalDistance = 0;
double scale = PICTURE_SCALE;
int moveType = 0;
